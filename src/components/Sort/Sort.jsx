...
const Sort = React.memo(({items, onSortBy}) => {
        ...
        return (
            ...
            <div className="sort" ref={softRef}>
                <p>
                    ...
                    Сортировка по: <span className="sort__chosen" onClick={togglePopup}>{items[selectItem].name}</span>
                </p>
                                        ...
                                        <ul>
                                            {
                                                items.map( (item, idx) => (
                                                    <li key={ item.type + '-' + idx} 
                                                        className={ selectItem === idx ? "active" : ""} 
