...
const Sort = React.memo(({items, sortBy, onSortBy}) => {
        ...
        //Получаем объект, зная тип сортировки
        const sortByObj = items.find( item => item.type === sortBy );
        ...
        return (
            ...
            <div className="sort" ref={softRef}>
                <p>
                    ...
                    Сортировка по: <span className="sort__chosen" onClick={togglePopup}>{sortByObj.name}</span>
                </p>
